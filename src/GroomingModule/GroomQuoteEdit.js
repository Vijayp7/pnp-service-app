...
export class GroomQuoteEdit extends Component {
    constructor(props){
        super(props);
    }
    state = {
      ...
      SubmitQuote=()=>{
        ...
        Services.getInstance().submitQuote(obj).then((result)=>{
          ...
          const obj1 = {
            notification: {
              title: "Petsfolio",
              body: user.first_name + user.last_name + " Has Edited Their Proposal For Dog Grooming",
              sound: "default"
            },
                  ...
                  <div class="srvc-dtls-adnt">
                    ...
                    <div class="srvc-dtls-item tm">
                      <div class="srvc-dtls-item-lft">
                        ...
                        <h6>Selected Preferable Time</h6>
                      </div>
                      <div class="srvc-dtls-item-rht ctmng">
                        {/* <span>{this.state.sp_time1}</span> */}
                        {/* <div class="c-tmng">
                            ...
                            <div class="trng-adons">
                              <div class="ad-ons-cst">
                                <input
                                  ...
                                  min="06:00" max="12:00" pattern="(09|1[0-5]):[0-5]\d"
                                  />
                              </div>
                              {/* <small>AM</small> */}
                            </div>
                              ...
                              <div class="trng-adons">
                                <div class="ad-ons-cst">
                                  <input 
                                    ...
                                    value={this.state.sp_time}
                                    onChange={this.handleChange}
                                    min="12:00" max="22:00" pattern="(09|1[0-5]):[0-5]\d"
                  ...
                  <div class="srvc-dtls-pckg">
                    ...
                    <div class="srvc-dtls-item pckg">
                      <div class="srvc-dtls-item-lft">
                        ...
                        <h6>{this.state.petData.package_name}</h6>
                      </div>
                    </div>
